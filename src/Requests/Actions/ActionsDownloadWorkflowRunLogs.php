 ...
 * 1 minute. Look for
 * `Location:` in the response header to find the URL for the download. Anyone with
 * read access to the repository can use
 * this endpoint. If the repository is private you must use an
 * access token with the `repo` scope. GitHub Apps must have
 * the `actions:read` permission to use this
 * endpoint.
 */
