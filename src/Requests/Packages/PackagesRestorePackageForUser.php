 ...
 *
 * To use
 * this endpoint, you must authenticate using an access token with the `read:packages` and
 ...
 * must have admin permissions to the package you want to restore. For the list of these registries,
