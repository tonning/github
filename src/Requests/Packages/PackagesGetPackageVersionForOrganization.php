 ...
 * with the `read:packages` scope. If the `package_type` belongs to a GitHub Packages registry that
 * only supports repository-scoped permissions, your token must also include the `repo` scope. For the
 * list of GitHub Packages registries that only support repository-scoped permissions, see "[About
