 ...
 * assignment for each user specified.
 * This will cause the specified users to lose access to GitHub
 * Copilot at the end of the current billing cycle, and the organization will not be billed further for
 * those users.
 *
 * For more information about Copilot Business pricing, see "[Pricing for GitHub Copilot
