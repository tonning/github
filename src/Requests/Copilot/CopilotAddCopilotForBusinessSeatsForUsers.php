 ...
 * The organization will be billed accordingly. For more information
 * about Copilot Business pricing, see "[Pricing for GitHub Copilot
 ...
 *
 * In order for an admin
 * to use this endpoint, the organization must have a Copilot Business subscription and a configured
 * suggestion matching policy.
 * For more information about setting up a Copilot Business subscription,
 * see "[Setting up a Copilot Business subscription for your
 ...
 * For
 * more information about setting a suggestion matching policy, see "[Configuring suggestion matching
 * policies for GitHub Copilot in your
 ...
 */
class CopilotAddCopilotForBusinessSeatsForUsers extends Request implements HasBody
{
	use HasJsonBody;
