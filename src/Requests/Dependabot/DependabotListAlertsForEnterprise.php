 ...
 * To use this
 * endpoint, you must be a member of the enterprise, and you must use an
 * access token with the `repo`
 * scope or `security_events` scope.
 * Alerts are only returned for organizations in the enterprise for
 * which you are an organization owner or a security manager. For more information about security
 * managers, see "[Managing security managers in your
